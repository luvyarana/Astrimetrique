...
* 🔍 **Photometric Diffing & Transient Detection**:
  ...
  * Signed difference map ($\Delta I = I_A \setminus s \cdot I_{B,\text{aligned}}$) and absolute difference map.
...
git clone https://github.com/luvyarana/Astrimetrique.git
cd Astrimetrique
...
$$\xi = \frac{\cos\delta \sin(\alpha \setminus \alpha_0)}{\sin\delta \sin\delta_0 + \cos\delta \cos\delta_0 \cos(\alpha \setminus \alpha_0)}$$
$$\eta = \frac{\sin\delta \cos\delta_0 \setminus \cos\delta \sin\delta_0 \cos(\alpha \setminus \alpha_0)}{\sin\delta \sin\delta_0 + \cos\delta \cos\delta_0 \cos(\alpha \setminus \alpha_0)}$$
